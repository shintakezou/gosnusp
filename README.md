...
- [Implementation of SNUSP interpreters on RosettaCode](http://rosettacode.org/wiki/Execute_SNUSP). The [C interpreter](http://rosettacode.org/wiki/RCSNUSP/C) should be mine; cfr. also on sourceforge (while I am writing, sf is in static offline mode, so I can't get the right address; I will update this later…)
...
- current cell values should be given as program return code? It is not (yet?)
